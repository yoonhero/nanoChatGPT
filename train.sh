...
torchrun train.py --batch_size=128 --max_epoch=100 --eval_interval=10 --save_interval=5 --gradient_accumulation_interval=2 --output_dir=/content/drive/MyDrive/tmp/checkpoints/ --model_size=BASIC --with_lr_scheduler --from_cache --cache_directory=/content/drive/MyDrive/large_dataset.tar.gz

...
python train.py --batch_size=100 --max_epoch=100 --eval_interval=1 --save_interval=5 --gradient_accumulation_interval=2 --output_dir=tmp/checkpoints/ --model_size=BASIC --dataset_path=tmp/corpus.txt --cache_directory=dataset/tokenized_corpus.tar.gz
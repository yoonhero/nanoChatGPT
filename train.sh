...
python train.py --batch_size=64 --max_epoch=100 --eval_interval=10000 --save_interval=1000 --gradient_accumulation_interval=2 --output_dir=tmp/checkpoints/ --model_size=BASIC --dataset_path=tmp/corpus.txt --cache_directory=dataset/tokenized_corpus.tar.gz --with_lr_scheduler